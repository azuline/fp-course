...
--   Exercises are generally increasing in difficulty, though some people
--   may find later exercise easier.
-- + Bonus for using the provided functions or for using one exercise
--   solution to help solve another.
-- + Approach with your best available intuition; just dive in and do
--   what you can!
